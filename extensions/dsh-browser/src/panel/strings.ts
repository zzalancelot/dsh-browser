...
const EN: PanelCopy = {
  ...
  settings: {
    ...
    bridgeHelp: 'Leave blank to detect a local service, or set ws://<host-ip>:3080/ext/bridge for LAN',
    bridgePlaceholder: 'ws://192.168.x.x:3080/ext/bridge',
...
const ZH: PanelCopy = {
  ...
  settings: {
    ...
    title: '设置',
    bridgeAddress: '桥地址',
    bridgeHelp: '留空自动检测本机；局域网填写 ws://<主机IP>:3080/ext/bridge',
    bridgePlaceholder: 'ws://192.168.x.x:3080/ext/bridge',
